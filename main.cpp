...
void displayOut(ST7789 display, PicoGraphics_PenRGB332 graphics, Pen bg, Pen fg, Point location, char* text) {
  graphics.set_pen(bg);
  graphics.clear();
  graphics.set_pen(fg);
  graphics.text(text, location, 1024, 4.0f);
...
int main() {
  ...
  Pen bgpen = graphics.create_pen(0, 0, 0);
  Pen fgpen = graphics.create_pen(255, 255, 255);
  ...
  displayOut(st7789, graphics, pen_black, pen_white, meow, "booooooting...");
  //
